...
const MenuItemCategory_1 = require("../MenuItemCategory/MenuItemCategory");
...
__decorate([
    typeorm_1.ManyToOne(type => MenuItemCategory_1.MenuItemCategory, menuItemCategory => menuItemCategory.menuItems, { nullable: false }),
    typeorm_1.JoinColumn({ name: 'category' }),
    __metadata("design:type", MenuItemCategory_1.MenuItemCategory)
...
__decorate([
    typeorm_1.OneToMany(type => MenuItemRecipe_1.MenuItemRecipe, menuItemRecipe => menuItemRecipe.menuItem),
