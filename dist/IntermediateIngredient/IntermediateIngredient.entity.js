...
__decorate(
  ...
  IntermediateIngredient.prototype,
  'id',
  void 0,
);
__decorate(
...
__decorate(
  [
    typeorm_1.ManyToOne(
      type => price_unit_entity_1.PriceUnit,
...
__decorate(
  [
    typeorm_1.OneToMany(
      type =>
        IntermediateIngredientRecipe_entity_1.IntermediateIngredientRecipe,
...
__decorate(
  [
    typeorm_1.OneToMany(
      type => MenuItemRecipe_entity_1.MenuItemRecipe,
...
IntermediateIngredient = __decorate(
  [
    ...
    typeorm_1.Index('intermediate_ingredients_name_key', ['name'], {
      unique: true,
    }),
  ],
