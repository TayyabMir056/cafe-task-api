...
__decorate([
    typeorm_1.ManyToOne(type => PriceUnit_1.PriceUnit, priceUnit => priceUnit.inventoryIngredients, {
        nullable: false,
    }),
...
__decorate([
    typeorm_1.OneToMany(type => IntermediateIngredientRecipe_1.IntermediateIngredientRecipe, intermediateIngredientRecipe => intermediateIngredientRecipe.inventoryIngredient),
    __metadata("design:type", Array)
], InventoryIngredient.prototype, "intermediateIngredientRecipes", void 0);
__decorate([
    typeorm_1.OneToMany(type => MenuItemRecipe_1.MenuItemRecipe, menuItemRecipe => menuItemRecipe.inventoryIngredient),
    __metadata("design:type", Array)
